...
public class CustomNettyRoutingFilter implements GlobalFilter, Ordered {
    ...
    private static final Log log = LogFactory.getLog(org.springframework.cloud.gateway.filter.NettyRoutingFilter.class);
    ...
    public CustomNettyRoutingFilter(HttpClient httpClient, ObjectProvider<List<HttpHeadersFilter>> headersFiltersProvider,
    ...
    public Mono<Void> filter(ServerWebExchange exchange, GatewayFilterChain chain) {
        ...
        Flux<HttpClientResponse> responseFlux = getHttpClient(route, exchange).headers(headers -> {
            ...
            copyResponse(res, exchange.getResponse());
